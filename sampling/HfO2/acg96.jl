...
pranges = [a-2.0 a+2.0; b-2.0 b+2.0; c-2.0 c+2.0];        
pdims = [21, 21, 21];        
...
lranges = [a-2.0 a+2.0; b-2.0 b+2.0; c-2.0 c+2.0; 75 105; 90 110; 75 105];        
ldims = [6, 6, 6, 4, 4, 4];        
...
ACG.writeEXTXYZ2("HfO2sg14n96.xyz", species, natoms, lattices, atomtypes, atombases);
