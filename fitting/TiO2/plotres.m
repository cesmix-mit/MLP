...
snap2 = [2 69.047 69.038 1009.350 1009.260
4 12.265 12.266 297.113 297.097
6 6.582 6.582 202.039 202.023
8 4.632 4.631 171.757 171.729
10 3.678 3.677 150.214 150.178];
snap2(:,2:end) = snap2(:,2:end)/1e3;
snap2 = snap2(:,[1 2 4 3 5]);

eerr = 1e3*[ace(:,2) snap(:,2) snap2(:,2) pod(:,2) pod23(:,2)];
ferr = 1e3*[ace(:,3) snap(:,3) snap2(:,3) pod(:,3) pod23(:,3)];
...
axis([5 95 1.5 200]);
set(gca, 'YTick', 10*[0.2 0.4 0.8 1.6 3.2 6.4 12.8])
print -dpng TiO2_train_energy_error.png
...
leg.ItemTokenSize = [50,10];
axis([5 95 90 1500]);
set(gca, 'YTick', [90 180 360 720 1440])
print -dpng TiO2_train_force_error.png

eerr = 1e3*[ace(:,4) snap(:,4) snap2(:,4) pod(:,4) pod23(:,4)];
ferr = 1e3*[ace(:,5) snap(:,5) snap2(:,5) pod(:,5) pod23(:,5)];
...
axis([5 95 1.5 200]);
set(gca, 'YTick', 10*[0.2 0.4 0.8 1.6 3.2 6.4 12.8])
print -dpng TiO2_test_energy_error.png
...
axis([5 95 90 1500]);
set(gca, 'YTick', [90 180 360 720 1440])
print -dpng TiO2_test_force_error.png
