...
for j = 0:5        
    ...
    if j == 0
        rcut = 4.263781068894793                
    elseif j == 1
        rcut = 4.697840520739992       
    elseif j==2
        rcut = 4.586773965605111
    elseif j==3 
        rcut = 3.9   
    elseif j==4
        rcut = 4.9
    ...
    descriptors[1] = SNAPparams(species = [:Ni], nbody = 1, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
    descriptors[2] = SNAPparams(species = [:Ni], nbody = 4, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
