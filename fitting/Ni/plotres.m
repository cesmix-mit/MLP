...
axis([5 145 0.5 24]);
text(70,11.3,"Ni","FontSize",28,"FontWeight","bold");
print -dpng Ni_test_energy_error.png
...
set(gca,'FontSize',22); 
set(gca,'LooseInset',get(gca,'TightInset'))
set(gca, 'YTick', [20 40 80 160])
% xlabel("Number of descriptors", 'FontSize', 18);
% ylabel("MAE force error (meV/Å)", 'FontSize', 18);
leg = legend({'ACE','SNAP','POD'},'interpreter', 'latex', 'FontSize', 18, 'Location', 'NE');
leg.ItemTokenSize = [50,10];
axis([5 145 15 240]);
text(70,0.14*1e3,"Ni","FontSize",28,"FontWeight","bold");
print -dpng Ni_test_force_error.png
