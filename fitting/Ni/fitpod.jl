...
for j = 0:5    
    # POD Descriptors
    if j == 0
        rcut =  4.249859465105215  
        rin = 1.439229361444371
    ...
    elseif j == 1
        rcut = 4.433012407369337  
        rin = 1.1560697082226288
        descriptors[1] = POD(nbody=1, pdegree=[0], nbasis = [1], rin = rin, rcut=rcut)
    ...
    elseif j==2
        rcut = 4.399339941085949  
        rin = 1.138990409085067
        descriptors[1] = POD(nbody=1, pdegree=[0], nbasis = [1], rin = rin, rcut=rcut)
    ...
    elseif j==3 
        rcut = 4.254205725991025  
        rin = 0.9725119508434271
        descriptors[1] = POD(nbody=1, pdegree=[0], nbasis = [1], rin = rin, rcut=rcut)
