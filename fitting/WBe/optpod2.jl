...
for j = 0:0
    ...
    # POD Descriptors
    if j == 0
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[2,2,2], nbasis = [1, 2], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
    elseif j == 1
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[2,6], nbasis = [3], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[2,4,3], nbasis = [3, 3], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
    elseif j==2
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[3,6], nbasis = [6], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[3,6,4], nbasis = [5, 4], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
    elseif j==3 
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[4,6], nbasis = [8], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[4,6,5], nbasis = [8, 5], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-4)
    elseif j==4
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[6,8], nbasis = [11], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-6)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[6,8,7], nbasis = [10, 7], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-6)
    elseif j==5           
        descriptors[1] = POD(nbody=2, species = [:W,:Be], pdegree=[6,12], nbasis = [10], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-6)
        descriptors[2] = POD(nbody=3, species = [:W,:Be], pdegree=[6,12,10], nbasis = [12,10], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-6)
    end
