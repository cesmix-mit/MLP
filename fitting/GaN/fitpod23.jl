...
for j = 0:4
    ...
    if j == 0
        ...
        descriptors[2] = POD(nbody=2, species = [:Ga,:N], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
        descriptors[3] = POD(nbody=3, species = [:Ga,:N], pdegree=[2,2,2], nbasis = [1, 2], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
    elseif j == 1
        descriptors[1] = POD(nbody=1, species = [:Ga,:N], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma)
        descriptors[2] = POD(nbody=2, species = [:Ga,:N], pdegree=[2,6], nbasis = [3], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
        descriptors[3] = POD(nbody=3, species = [:Ga,:N], pdegree=[2,4,3], nbasis = [3, 3], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
    elseif j==2
        descriptors[1] = POD(nbody=1, species = [:Ga,:N], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma)
        descriptors[2] = POD(nbody=2, species = [:Ga,:N], pdegree=[3,6], nbasis = [6], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
        descriptors[3] = POD(nbody=3, species = [:Ga,:N], pdegree=[3,6,4], nbasis = [5, 4], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
    elseif j==3 
        descriptors[1] = POD(nbody=1, species = [:Ga,:N], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma)
        descriptors[2] = POD(nbody=2, species = [:Ga,:N], pdegree=[4,6], nbasis = [8], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
        descriptors[3] = POD(nbody=3, species = [:Ga,:N], pdegree=[4,6,5], nbasis = [8, 5], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
    elseif j==4
        descriptors[1] = POD(nbody=1, species = [:Ga,:N], pdegree=[2,4], nbasis = [2], rin = rin, rcut=rcut, gamma0 = gamma)
        descriptors[2] = POD(nbody=2, species = [:Ga,:N], pdegree=[6,8], nbasis = [11], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
        descriptors[3] = POD(nbody=3, species = [:Ga,:N], pdegree=[6,8,7], nbasis = [10, 7], rin = rin, rcut=rcut, gamma0 = gamma, hybrid23=true, projectiontol=1e-8)
    elseif j==5           
    ...
    writedlm("results/fitpod23trainerror" * string(j) *  ".txt", [energyerrors forceerrors])    
    writedlm("results/fitpod23testerror" * string(j) *  ".txt", [energytesterrors forcetesterrors])    
end
