...
pranges = [a-1 a+1; b-1 b+1; c-1 c+1];        
pdims = [21, 21, 21];        
...
lranges = [a-1 a+1; b-1 b+1; c-1 c+1; 70 90; 80 100; 110 130];        
ldims = [6, 6, 6, 4, 4, 4];        
...
lattices, atombases = ACG.selectconfigurations(la[1:3,:], la[4:6,:], la[7:9,:], ba[:,:,:,1], atomtype, descriptors, 1e-4);
...
ACG.writeEXTXYZ2("HfB2n24.xyz", species, natoms, lattices, atomtypes, atombases);
