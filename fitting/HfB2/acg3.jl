...
pranges = [a-0.5 a+0.5; b-0.5 b+0.5; c-0.5 c+0.5];        
pdims = [21, 21, 21];        
...
lranges = [a-0.5 a+0.5; b-0.5 b+0.5; c-0.5 c+0.5; 70 90; 80 100; 110 130];        
ldims = [6, 6, 6, 4, 4, 4];        
...
lattices, atombases = ACG.selectconfigurations(la[1:3,:], la[4:6,:], la[7:9,:], ba[:,:,:,1], atomtype, descriptors, 4e-5);
...
ACG.writeEXTXYZ2("HfB2n3.xyz", species, natoms, lattices, atomtypes, atombases);
