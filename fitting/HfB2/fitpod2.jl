...
# test data
#testpath = "../../data/HfB2/"
#testfolders = ["EOS1","EOS2","Deformed1","Deformed2","Deformed3","Distorted1","Distorted2","MD1","MD2"]
#testfolders = ["EOS2"]
#percentage = 20.0;
...
#for j = 3:3
    ...
    writedlm("results/fitpod23testenergies" * string(j) *  ".txt", [energies[1]*3 energies[2]*6])    
