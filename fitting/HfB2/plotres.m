...
esnap2 = [0.10491 0.0175381 0.00666048 0.0032797 0.00232867];
fsnap2 = [0.397851 0.100211 0.0386363 0.0205506 0.0144664];
eerr = 1e3*[ace(:,2) snap(:,2) esnap2(:) pod(:,2) pod23(:,2)];
ferr = 1e3*[ace(:,3) snap(:,3) fsnap2(:) pod(:,3) pod23(:,3)];
...
axis([5 95 1 300]);
set(gca, 'YTick', [1 2 4 8 16 32 64 128 256])
print -dpng HfB2_train_energy_error.png
...
leg.ItemTokenSize = [50,10];
axis([5 95 9 650]);
set(gca, 'YTick', [10 20 40 80 160 320 640])
print -dpng HfB2_train_force_error.png

% eerr = 1e3*[ace(:,4) snap(:,4) pod(:,4) pod23(:,4)];
% ferr = 1e3*[ace(:,5) snap(:,5) pod(:,5) pod23(:,5)];
% 
% figure(1); clf; 
% semilogy(num(:,1), eerr(:,1),'-o', 'LineWidth', 2, 'MarkerSize', 10); 
% hold on
...
% print -dpng HfB2_test_energy_error.png
% 
% figure(2); clf; 
% semilogy(num(:,1), ferr(:,1),'-o', 'LineWidth', 2, 'MarkerSize', 10); 
% hold on
...
% print -dpng HfB2_test_force_error.png
% 
% 
% figure(2); clf; 
