...
for i = 1:n
    lat = ACG.setlatticefraction(s[i,1], s[i,1], s[i,2], alpha, beta, gamma, fraccoords, atomtype);
...
ACG.writeEXTXYZ2("HfB2g3.xyz", species, natoms, lattices, atomtypes, atombases);
