...
for j = 0:5        
    ...
    descriptors[1] = SNAPparams(species = [:Ge], nbody = 1, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
    descriptors[2] = SNAPparams(species = [:Ge], nbody = 4, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
