...
for j = 0:5        
    ...
    descriptors[1] = SNAPparams(species = [:Mo], nbody = 1, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
    descriptors[2] = SNAPparams(species = [:Mo], nbody = 4, twojmax = twojmx, rcutfac = rcut, rfac0 = 0.99363)
