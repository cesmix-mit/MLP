...
axis([5 145 0.3 20]);
text(70,8.9,"Cu","FontSize",28,"FontWeight","bold");
print -dpng Cu_test_energy_error.png
...
leg.ItemTokenSize = [50,10];
axis([5 145 8 210]);
text(70,0.11*1e3,"Cu","FontSize",28,"FontWeight","bold");
print -dpng Cu_test_force_error.png
