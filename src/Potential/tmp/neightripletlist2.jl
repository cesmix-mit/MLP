function makejk(n)
    ...
    #         fi = f2ij[1,ind2,:]
    #         wij[1,ind,:] = fi[indj[1:m],:]
    #         wik[1,ind,:] = fi[indk[1:m],:]
    #         fi = f2ij[2,ind2,:]
    #         wij[2,ind,:] = fi[indj[1:m],:]
    #         wik[2,ind,:] = fi[indk[1:m],:]
    #         fi = f2ij[3,ind2,:]
    #         wij[3,ind,:] = fi[indj[1:m],:]
    #         wik[3,ind,:] = fi[indk[1:m],:]
